...
class Encrypt:
	...
	def encrypt_params(self, word, key):
		...
		# print("encryptd_word: ", encryptd_word)
...
class Music():
	...
	def get_music_url(self, api_url, data=None):
		# api_rul: "https://music.163.com/weapi/song/enhance/player/url/v1?csrf_token="
		...
		for m_id, m_name in self.music_dic.items():
			...
			if res.status_code != 200 and res.content == "":
				...
				# print(content.get("data")[0].get("url"))
		# print(self.music_dic)
	...
	def search_music(self, name):
		...
		for music in temp_dic:
			...
			# if "live" in m_name or "Live" in m_name or "现场" in m_name:
				# print(m_name, m_id)
...
if __name__ == '__main__':
	# word = '{"ids":"[65312]","level":"standard","encodeType":"aac","csrf_token":""}'
	# s = Encrypt(word)
	# r = 'BwwX9xpTo28rPuk0secuMyyQS7ABgrWjOhKDOzxjJKLfiB/JJ30TU2y4rY7y77Em6YYCMMhUNS67yR2NUE0cqX21JrBSn32GhaDpqy6f8Rh6zoHdy/N97vHPDEieqMdiFkh/4JmxJ1Ay7e3RB1oazA=='
	# print(s.request_data)
	# print(s.request_data["params"] == r)
	...
	# data = '{"ids":"[65312]","level":"standard","encodeType":"aac","csrf_token":""}'
	# data = '{"ids":"[188230]","level":"standard","encodeType":"aac","csrf_token":""}'
	# data = '{"ids":"[401722037]","level":"standard","encodeType":"aac","csrf_token":""}'
	# music = Music()
	# s = music.search_music("遥远的她")
	# music.get_music_url(api, data=data)

	s = {188230:
			 {'name': '遥远的她 (Live)-张学友', 'url': 'http://m10.music.126.net/20210922191151/256aad236286839c55d0e4becc8b0ab6/yyaac/obj/wonDkMOGw6XDiTHCmMOi/3070783573/d031/0522/f2ce/2d38c663ae6d834afbaef9d57ee8e55e.m4a'},
		 401722037:
			 {'name': '遥远的她 (Live)-李克勤', 'url': 'http://m801.music.126.net/20210922191151/08f94ef8351677cb09d699c5fba33771/jdyyaac/050c/0152/550c/2f0abd300b68a7db5135bfcbfa2f1194.m4a'}
		 }
